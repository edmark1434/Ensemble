  ...
  useEffect(() => {
    ...
    const fragmentShader = `
      ...
      void main() {
        ...
        col -= fract(sin(dot(gl_FragCoord.xy, vec2(12.9898, 78.233))) * 43758.545) / 15.0 * uNoiseIntensity;
    ...
    // 👈 Replaced standard lagging setTimeout with an instant layout observer
    const handleResize = () => {
