...
export const InboxSideDetails: React.FC<InboxSideDetailsProps> = ({
  ...
  // Determine Creator (Defaulting to 'You' or first member if creator_id isn't explicitly set)
  ...
  return (
    <div
      className="w-72 md:w-80 h-full bg-[#0d0f1a] border-l border-white/10 flex flex-col flex-shrink-0 overflow-y-auto inbox-scroll-thin text-white"
    ...
    >
      ...
      <div className="flex flex-col items-center p-6 border-b border-white/10 text-center">
        ...
        {/* Creator Info Tag (For Group Chats) */}
        {isGroup && (
        ...
        {/* Action Button: View Profile (Only shown for 1-on-1 direct chats) */}
        {!isGroup && (
      ...
      <div className="p-2 space-y-2 flex-1">
        {/* 1. Customize Chat (Group Chat Name Editing) */}
        {isGroup && (
