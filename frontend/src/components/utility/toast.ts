...
const getClassName = (type: 'success' | 'error' | 'loading' | 'custom'): string => {
  const themes = {
    success: '!bg-white dark:!bg-dark-surface !text-gray-900 dark:!text-white border-emerald-200 dark:border-emerald-500/30 border-l-4 !border-l-emerald-500',
    error: '!bg-white dark:!bg-dark-surface !text-gray-900 dark:!text-white border-red-200 dark:border-red-500/30 border-l-4 !border-l-red-500',
    loading: '!bg-white dark:!bg-dark-surface !text-gray-900 dark:!text-white border-blue-200 dark:border-blue-500/30 border-l-4 !border-l-blue-500',
    custom: '!bg-white dark:!bg-dark-surface !text-gray-900 dark:!text-white border-gray-200 dark:border-white/10'
  };
