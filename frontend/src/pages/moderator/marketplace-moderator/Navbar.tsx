import { Flag, LayoutDashboard, Scale, ShieldBan, ShoppingBag, Ticket, Users } from 'lucide-react';
...
const navItems = [
  ...
  { label: 'Restrictions', icon: ShieldBan, to: '/moderator/marketplace/restrictions' },
