  ...
  return (
    ...
    >
      <div className="mb-6 flex flex-wrap items-end justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-sm text-zinc-500">
            Same report desk as Support — scoped to forum groups, discussions, comments, and
            related member reports.
          </p>
        </div>
        <button
          type="button"
      ...
      <p className="mt-4 text-xs text-zinc-600">
        Account actions live under{' '}
        <Link to="/moderator/forum/user-team" className="text-violet-300 hover:underline">
          User &amp; Team
        </Link>{' '}
        (admin console placeholder for forum staff).
      </p>
    </main>
  );
}
