...
const GigSavesPage: React.FC = () => {
    ...
    return (
      <div className="flex flex-col items-center justify-center py-20 px-4 text-center">
        ...
        <p className="text-sm text-gray-500 dark:text-zinc-400 mb-8 max-w-md">
          You haven't saved any freelance services. Browse the marketplace and save services you're interested in!
        </p>
        <button
  ...
  return (
    <GigList
      ...
      baseRoute="/gigs/saved-services"
      loading={loading}
    />
  );
};

export default GigSavesPage;