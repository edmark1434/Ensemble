...
export const OrderPitchStep: React.FC<OrderPitchProps> = ({
  gig,
  bidAmount,
  setBidAmount,
  additionalWorkRate,
  ...
  return (
    <div className="space-y-5 text-left">
      <div>
        ...
        <p className="text-xs text-gray-500 dark:text-zinc-400">Specify your order bid within the client's budget and state your pitch.</p>
      </div>
          ...
          <div className="relative">
            ...
            <input
              ...
              onBlur={() => {
                ...
                if (gig && num < gig.minBudget) {
                  setBidAmount(gig.minBudget.toString());
                  setErrors((prev) => ({
                    ...prev,
                    bidAmount: `You cannot input under ${gig.minBudget.toLocaleString()}, so it's been adjusted.`
                  }));
                  setErrorCountdown(3);
                } else if (gig && num > gig.maxBudget) {
                  setBidAmount(gig.maxBudget.toString());
                  setErrors((prev) => ({
                    ...prev,
                    bidAmount: `You cannot input over ${gig.maxBudget.toLocaleString()}, so it's been adjusted.`
                  }));
                  setErrorCountdown(3);
                }
              }}
