...
interface GigListViewTypeProps {
  viewType: ViewType;
  onViewTypeChange: (type: ViewType) => void;
}

const GigListViewType: React.FC<GigListViewTypeProps> = ({ viewType, onViewTypeChange }) => {
...
export default GigListViewType;