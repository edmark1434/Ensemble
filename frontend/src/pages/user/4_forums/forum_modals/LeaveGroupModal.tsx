// src/pages/user/4_forums/forum_modals/LeaveGroupModal.tsx
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm animate-fade-in-modal">
      <div className="w-full max-w-md rounded-2xl border border-white/10 bg-[#0d0f1a] p-6 shadow-2xl animate-scale-in">
        ...
        <p className="text-sm text-zinc-400 mb-2">
          Are you sure you want to leave <span className="text-white font-medium">{groupName}</span>?
        </p>
        <p className="text-xs text-zinc-500 mb-6">
          You will lose access to all group posts and discussions. You can rejoin later if the group is public.
        </p>
