...
import { Plus, Maximize2, X, Play, ChevronLeft, ChevronRight } from "lucide-react";
...
export const Profile_Gallery: React.FC<ProfileGalleryProps> = ({ accountId, isOwner }) => {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        {isOwner && (
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-full text-sm font-semibold transition-colors"
          >
      ...
      <GalleryLightbox items={items} selectedItem={selectedItem} setSelectedItem={setSelectedItem} />
