...
function ProfileRouteSkeleton() {
  return (
    <div className="min-h-screen bg-[#080a12] p-4 md:p-8">
...
export default function ProfileRoute() {
  ...
  if (state === "error") {
    return (
      <div className="flex min-h-screen items-center justify-center bg-[#080a12] px-4 text-center text-sm text-zinc-400">
