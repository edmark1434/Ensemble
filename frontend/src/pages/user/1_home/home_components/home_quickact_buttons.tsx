...
export const HomeQuickActButtons: React.FC = () => {
  ...
  > = {
    blue: {
      ...
      iconBgHover: "group-hover:bg-blue-500/20 group-hover:text-blue-400",
    ...
    emerald: {
      ...
      iconBgHover: "group-hover:bg-emerald-500/20 group-hover:text-emerald-400",
      textColorHover: "group-hover:text-emerald-300",
    },
    amber: {
      borderHover: "hover:border-amber-500/40",
      bgHover: "hover:bg-amber-500/[0.12]",
      glow: "hover:shadow-[0_0_15px_rgba(245,158,11,0.2)]",
      iconBgHover: "group-hover:bg-amber-500/20 group-hover:text-amber-400",
      textColorHover: "group-hover:text-amber-300",
    },
    purple: {
      borderHover: "hover:border-purple-500/40",
      bgHover: "hover:bg-purple-500/[0.12]",
      glow: "hover:shadow-[0_0_15px_rgba(168,85,247,0.2)]",
      iconBgHover: "group-hover:bg-purple-500/20 group-hover:text-purple-400",
    ...
    rose: {
      ...
      iconBgHover: "group-hover:bg-rose-500/20 group-hover:text-rose-400",
      textColorHover: "group-hover:text-rose-300",
    },
    cyan: {
      borderHover: "hover:border-cyan-500/40",
      bgHover: "hover:bg-cyan-500/[0.12]",
      glow: "hover:shadow-[0_0_15px_rgba(6,182,212,0.2)]",
      iconBgHover: "group-hover:bg-cyan-500/20 group-hover:text-cyan-400",
      textColorHover: "group-hover:text-cyan-300",
    },
    teal: {
      borderHover: "hover:border-teal-500/40",
      bgHover: "hover:bg-teal-500/[0.12]",
      glow: "hover:shadow-[0_0_15px_rgba(20,184,166,0.2)]",
      iconBgHover: "group-hover:bg-teal-500/20 group-hover:text-teal-400",
      textColorHover: "group-hover:text-teal-300",
    },
    indigo: {
      borderHover: "hover:border-indigo-500/40",
      bgHover: "hover:bg-indigo-500/[0.12]",
      glow: "hover:shadow-[0_0_15px_rgba(99,102,241,0.2)]",
      iconBgHover: "group-hover:bg-indigo-500/20 group-hover:text-indigo-400",
      textColorHover: "group-hover:text-indigo-300",
    },
  };
