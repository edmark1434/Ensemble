...
export const HomeBannerVersion: React.FC = () => {
  return (
    <div className="relative flex items-center gap-2 bg-white/70 dark:bg-zinc-950/70 px-3 py-1 backdrop-blur-md transition-all duration-300 border-y border-gray-300 dark:border-white/15 hover:border-gray-500 dark:hover:border-zinc-400/50">
      ...
      <div className="absolute -bottom-[1px] -left-[1px] h-1.5 w-1.5 border-b border-l border-gray-500/80 dark:border-zinc-400/80" />
      <div className="absolute -bottom-[1px] -right-[1px] h-1.5 w-1.5 border-b border-r border-gray-500/80 dark:border-zinc-400/80" />

      {/* Gray Blinking Live Indicator Dot */}
      <span className="relative flex h-1.5 w-1.5 items-center justify-center">
        <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-gray-500 dark:bg-zinc-400 opacity-75" />
        <span className="relative inline-flex h-1.5 w-1.5 rounded-full bg-gray-500 dark:bg-zinc-400" />
      </span>

      {/* Thin Gray Version Text */}
      <span
        className="text-[10px] font-extralight uppercase tracking-[0.2em] text-gray-700 dark:text-zinc-300 animate-pulse-glow"
