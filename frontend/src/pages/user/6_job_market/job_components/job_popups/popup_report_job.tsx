...
const PopupReportJob: React.FC<PopupReportJobProps> = ({
  isOpen,
  jobTitle,
  onClose,
  onSubmitReport,
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Auto-close smoothly after timer completes
    setTimeout(() => {
      handleResetAndClose();
    }, AUTO_CLOSE_MS);
  };
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-xs text-zinc-400 mt-0.5 max-w-[240px]">
                      Thank you. Our moderation team will review this job post shortly.
                    </p>
                  </div>
