      ...
      >
        {selectedJob && (
          <>
            ...
            <div className="flex-1 overflow-y-auto p-5 md:p-6 space-y-5 thin-scrollbar">
              ...
              <div className="p-3.5 rounded-xl border border-white/10 bg-white/5 flex items-center justify-between">
                ...
                <div className="text-right">
                  <p className="text-[9px] uppercase font-bold text-zinc-500 mb-0.5 flex items-center gap-1 justify-end">
            ...
            <div className="p-4 border-t border-white/10 bg-[#0d0f1a] shrink-0 space-y-3">
