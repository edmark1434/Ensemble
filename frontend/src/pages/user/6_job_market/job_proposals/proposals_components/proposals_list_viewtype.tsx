...
interface ProposalsListViewTypeProps {
  viewType: ViewType;
  onViewTypeChange: (type: ViewType) => void;
}

export const ProposalsListViewType: React.FC<ProposalsListViewTypeProps> = ({
  viewType,
  onViewTypeChange,
}) => {
      ...
      {options.map((opt) => {
        ...
        return (
          ...
          >
            {isActive && (
              <motion.div
                layoutId="activeProposalsViewType"
...
export default ProposalsListViewType;