...
interface ProposalCreateHeaderProps {
  currentSlide: number;
  onReturn: () => void;
}

export const ProposalCreateHeader: React.FC<ProposalCreateHeaderProps> = ({ currentSlide, onReturn }) => {
  return (
    <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8">
      ...
      <div className="flex items-center w-full max-w-lg mx-auto md:mx-0 relative justify-between z-0">
        {PROPOSAL_WIZARD_STEPS.map((step, idx) => {
...
export default ProposalCreateHeader;