...
const CreditShop: React.FC = () => {
  ...
  // Platform Business Logic Constants
  const creditToPesoRate = 1.0; // Base rate: 1 credit = 1 PHP
  const platformFeeRate = 0.20; // 20% platform share take cut
  ...
  const handleConfirmCashoutDisbursement = () => {
    ...
    const xenditDisbursementPayload = {
      ...
      currency: "PHP",
      description: `Credit Cashout redemption platform transaction minus fee processing overhead.`,
    };
  ...
  return (
    <div className="min-h-screen bg-[#080a12] text-white selection:bg-blue-500/30 relative">
      <style>{`
        .pricing-card {
      ...
      <div className="mx-auto max-w-7xl p-6 md:p-8 relative z-10">
        ...
        {activeTab === "membership" && (
          <div className="grid gap-7 md:grid-cols-3 items-stretch animate-fadeIn">
        ...
        {/* CASHOUT VIEW */}
        {activeTab === "cashout" && (
          <div className="max-w-2xl mx-auto bg-[#0d0f1a]/80 backdrop-blur-md border border-[#1e2130] rounded-2xl p-6 md:p-8 animate-fadeIn space-y-8">
            <div>
            ...
            <form onSubmit={handleOpenCashoutCheckout} className="space-y-6">
              ...
              {/* Step 3: Amount Configuration & Split Computations */}
              <div className="space-y-3">
                ...
                {/* Advanced Multi-tier platform split breakdown view */}
                {cashoutAmount && parseInt(cashoutAmount) > 0 && parseInt(cashoutAmount) <= userCurrentCredits && (
                  <div className="p-4 bg-zinc-900/60 border border-[#1e2130] rounded-xl space-y-2.5 text-xs animate-fadeIn">
                ...
                {cashoutAmount && parseInt(cashoutAmount) > userCurrentCredits && (
                  <div className="p-3 bg-red-500/10 border border-red-500/20 text-red-400 rounded-xl text-xs flex items-center gap-2 animate-fadeIn">
      ...
      {isPackModalOpen && selectedPack && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm animate-fadeIn">
          <div className="w-full max-w-md bg-[#0d0f1a] border border-[#1e2130] rounded-2xl p-6 relative shadow-2xl">
      ...
      {/* MODAL 3: CASHOUT DISBURSAL LIQUIDATION (Factoring 20% Cut) */}
      {isCashoutModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm animate-fadeIn">
          <div className="w-full max-w-md bg-[#0d0f1a] border border-[#1e2130] rounded-2xl p-6 relative shadow-2xl">
            <button
