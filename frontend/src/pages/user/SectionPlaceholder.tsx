...
const SectionPlaceholder = ({ title, subtitle = "This section is not built yet." }: SectionPlaceholderProps) => {
  return (
    <main className="relative z-10 px-4 py-4 md:ml-64 md:px-8 md:py-6">
      <section className="animate-[fadeIn_420ms_ease-out] rounded-2xl border border-white/15 bg-black/20 p-6 md:p-8">
        <h1 className="mb-2 text-2xl font-semibold tracking-wide text-zinc-100 md:text-3xl">{title}</h1>
