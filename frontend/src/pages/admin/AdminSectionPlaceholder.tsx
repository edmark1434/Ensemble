...
const AdminSectionPlaceholder = ({ title, subtitle = "This admin section is not built yet." }: AdminSectionPlaceholderProps) => {
  return (
    <main className="relative z-10 px-4 py-4 md:ml-72 md:px-8 md:py-6">
      <section className="animate-[fadeIn_420ms_ease-out] rounded-2xl border border-white/15 bg-white/8 p-6 md:p-8">
