...
const TABS: { id: TabId; label: string; icon: typeof LayoutGrid }[] = [
  ...
  { id: 'reports', label: 'User reports', icon: FileWarning },
...
export default function TicketManagementPage() {
  ...
  const valid: TabId[] = ['overview', 'tickets', 'disputes', 'reports', 'assignments'];
  ...
  return (
    <main className="min-h-screen md:pl-[260px]">
          ...
          <div className="flex flex-wrap items-center gap-2">
            <div className="relative min-w-[200px] flex-1 lg:w-72">
              ...
              <input
                ...
                placeholder="Search tickets, disputes, reports…"
      ...
      <div className="space-y-6 px-6 py-6 md:px-8 md:py-8">
        ...
        {tab === 'disputes' && <DisputesTab disputes={filteredDisputes} onUpdated={() => void load(true)} />}
        {tab === 'reports' && <ReportsTab reports={filteredReports} onUpdated={() => void load(true)} />}
  ...
  return (
    <>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        <ChartCard>
          <DonutChart title="Ticket status mix" segments={charts.ticketStatusMix} />
        </ChartCard>
        <ChartCard>
          <DonutChart title="Dispute status mix" segments={charts.disputeStatusMix} />
        </ChartCard>
      </div>
...
function DisputesTab({ disputes, onUpdated }: { disputes: Dispute[]; onUpdated: () => void }) {
  ...
  return (
    <div className="space-y-4">
      <DataTable
        columns={['Dispute', 'Title', 'Parties', 'Credits', 'Status', 'Assignee', 'Opened']}
        rows={disputes.map((d) => ({
          key: d.id,
          cells: [
            d.number,
