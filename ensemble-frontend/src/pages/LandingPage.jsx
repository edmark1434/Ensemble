...
// Stack: React 18, no external dependencies (Google Fonts via <link> in index.html)
//
// To use:
...
// ─── Navbar ───────────────────────────────────────────────────────────────────
const NAV_FEATURES  = ["Parallel Workflow", "Real-time Collaboration", "Story Structuring", "Frame Management", "Version History"];
const NAV_USECASES  = ["Film Production", "Documentary", "Short Films", "TV Series", "Student Projects"];
...
function Navbar({ onLogin, onSignup }) {
  ...
  const toggle = (name) => (val) => setOpenDD(val ? name : null);
