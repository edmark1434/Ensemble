const r=require('express').Router(),c=require('../controllers/TeamsControllers'),tasks=require('../controllers/TeamTaskControllers'),check=require('../middleware/CheckSession'),optionalSession=require('../middleware/OptionalSession'),auth=require('../middleware/RequireAuth');
r.get('/invite/:code',optionalSession,c.invitePreview);
r.use(check,auth);
