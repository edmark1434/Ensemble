...
* [x] Milestone activity messages align by the current viewer: the client sees client actions on the right, and the freelancer sees freelancer actions on the right.
